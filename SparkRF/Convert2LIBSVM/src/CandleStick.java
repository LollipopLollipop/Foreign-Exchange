...
//	}
	...
	public String toLIBSVMFormat() throws ParseException {
		// TODO Auto-generated method stub
		StringBuilder sb = new StringBuilder();
		sb.append(this.label+1);//LIBSVM supports only non-negative labels
		sb.append(" 1:");
		String timeForLIBSVM = this.time.replaceAll("\\W", "");
		//timeForLIBSVM.replaceAll("\\s+", "");
		//timeForLIBSVM.replaceAll(":", "");
		
		sb.append(timeForLIBSVM.substring(6));
		sb.append(" 2:");
		sb.append(this.high);
		sb.append(" 3:");
		sb.append(this.low);
